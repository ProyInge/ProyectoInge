...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <button id="derecha" type="button" runat="server" onserverclick="btnDerecha_Click" disabled="disabled" style="margin-left: 520px; margin-top: -240px; margin-right: 0px; margin-bottom: 0px; background-color: #24B8E0; color: white" href="" class="btn btn-lg"><span class="glyphicon glyphicon-chevron-right"></span></button>

    <button id="izquierda" type="button" runat="server" onserverclick="btnIzquierda_Click" disabled="disabled" style="margin-left: -55px; margin-top: -115px; margin-right: 0px; margin-bottom: 0px; background-color: #24B8E0; color: white" href="" class="btn btn-lg"><span class="glyphicon glyphicon-chevron-left"></span></button>
