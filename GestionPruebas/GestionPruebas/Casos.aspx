...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="max-height: 800px; max-width: 1000px; margin: 40px auto;">
        <div class="panel panel-primary" style="max-height: 800px; max-width: 900px; margin-left: 100px; margin-top: 40px">
            <div class="panel-heading" style="border-color: #3D3D3D; background-color: #3D3D3D; color: #0BF1F1">Caso de Prueba</div>
            <div class="row">
                ...
                <div class="col col-md-6">
                    <div class="panel-body" style="max-width: 400px;">
                        ...
                        <div style="height: 200px; width: 350px; overflow: auto;">
                            <asp:ListBox ID="reqSeleccionados" runat="server"></asp:ListBox> 
                        </div>
                    </div>
                </div>
            </div>
