            ...
            <div class="row">
                <div class="col col-md-6">
                    <div class="panel-body" style="max-width: 400px;">
                        ...
                        <textarea id="Textarea1" runat="server" rows="5" cols="48" style="max-height: 300px; max-width: 350px;" />
                ...
                <div class="col col-md-6">
                    <div class="panel-body" style="max-width: 400px;">
                        ...
                        <input id="Text2" runat="server" style="margin: 4px; width: 350px;" type="text" class="form-control" aria-describedby="nombre" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-md-6">
                        <div class="panel-body" style="max-width: 400px;">
                            ...
                            <textarea id="proposito" runat="server" rows="5" cols="48" style="max-height: 300px; max-width: 350px;" />
                            ...
                            <div class="col-xs-10" style="margin: 5px 5px 12px -10px; width: 100%">
                                <select id="barraEstado" class="form-control" name="estado" runat="server" aria-describedby="estado" required>
