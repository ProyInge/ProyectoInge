...
namespace GestionPruebas
{
    public partial class Reportes : System.Web.UI.Page
    {
        ...
        private EntidadEjecucion entEjecucion1;
        private EntidadNoConformidad[] conformidades1;
        private EntidadEjecucion entEjecucion2;
        ...
        {
            if (true || entEjecucion1 != null && conformidades1 != null)
            {
                ...
                //            doc.Add(table);
                //            doc.Close();
                //            descargaReporte(stream, "ReporteNoConformidades.pdf");
                //        }
                //    }
                ...
                //            float[] widths3 = new float[] { 100f, 100f, 80f, 80f };
                //            table3.SetWidths(widths3);
                //            PdfPCell cell3 = new PdfPCell(new Phrase("Porcentajes por cada no conformidad de ejecución"));
